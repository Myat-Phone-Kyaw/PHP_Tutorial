    ...
    <?php
        ...
        if (isset($_POST['create-btn'])) {
            ...
            if (!empty($title) && !empty($content)) {
                $query = "INSERT INTO `PostList`.`posts`(title, content, is_published, created_datetime) VALUES('$title', '$content', '$publish', current_timestamp())";
                    ...
                    <div class="card-body">
                        <form action="create.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"><button type="submit" name="create-btn" class="btn btn-primary">Create</button></div>
                            </div>
                        </form>
                    </div>
                </div>
