    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div class="ml-auto p-2"><a href="{{ url('/student') }}" class="text-decoration-none text-black">
                        <h3>Students</h3>
                    </a></div>
                <div class="p-2">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href={{ url('student/edit/' . $student->id) }} class="btn btn-sm btn-warning">Update</a>
