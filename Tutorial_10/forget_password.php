    ...
    if ($_POST['email'] == null) {
        ...
        if ($data > 0) {
            try {
                ...
                $mail->SMTPAuth   = true;
                $mail->Username   = 'myatphonekyaw5505@gmail.com';
                $mail->Password   = 'hjysqvofrwmzjlic';
                $mail->SMTPSecure = 'ssl';
                $mail->Port = 465;
                $mail->setFrom('myatphonekyaw5505@gmail.com');
                $mail->addAddress($_POST["email"]);
                $mail->isHTML(true);
                $mail->Subject = "Reset Password";
                $mail->Body = "To reset your password. Click <a href='http://localhost:8888/PHP_Tutorial/Tutorial_10/reset_password.php'>Here!</a>";
                $mail->send();
